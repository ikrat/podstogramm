...
import net.study.podstogramm.filter.MyinstaFilter;
import net.study.podstogramm.listener.ApplicationListener;
...
public class ResumeWebApplicationInitializer implements WebApplicationInitializer {
	...
	private void registerFilters(ServletContext container, WebApplicationContext ctx) {
		registerFilter(container, ctx.getBean(MyinstaFilter.class));
